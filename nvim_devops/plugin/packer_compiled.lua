...
_G.packer_plugins = {
  ...
  ["diagnosticls-configs-nvim"] = {
    loaded = true,
    path = "/Users/bekzatajan/.local/share/nvim/site/pack/packer/start/diagnosticls-configs-nvim",
  ...
  ["lsp-status.nvim"] = {
    loaded = true,
    path = "/Users/bekzatajan/.local/share/nvim/site/pack/packer/start/lsp-status.nvim",
